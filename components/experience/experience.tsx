  ...
  return (
    ...
    >
      <section className="flex flex-col items-center justify-center gap-[4rem] xl:gap-[6rem]">
        <h2 className="font-bold text-[32px] xl:text-[42px] dark:text-white">
          Experiences
        </h2>
        <VerticalTimeline
        ...
        >
          <VerticalTimelineElement
            ...
            dateClassName="!font-bold !text-[14px] !italic xl:!text-[1.1rem] dark:!text-white"
            iconStyle={{
          ...
          >
            <div className="mb-8">
              <div className="flex flex-col -space-y-2">
                <h2 className="!text-light-primary mb-2 font-semibold !text-[22px] xl:!text-[32px] dark:!text-dark-primary">
                  Subisu Cablenet Limited
                </h2>
                <p className="flex gap-[4px] !font-bold !text-[14px] xl:!text-[18px] dark:text-white ">
                  Technical Support Representative
                </p>
              </div>
              <p className="!text-[14px] xl:!text-[16px] dark:text-white">
